...
### Jupyter Notebooks
- Jupyter notebooks are a great way to combine code, text, and visualizations in one
...
::: {.callout-note}
- If you would like to follow along by typing in the code from the slides, this may be easiest in a Jupyter notebook.
:::
