...
- You will also need to install the **Jupyter** extensions below, which will allow you to use Jupyter notebooks in VS Code:

![](images/jupyter-ext.png){fig-align="center"}
