...
summary_table_image(df.groupby("group")["score"].describe().round(2), height = 0.9, fontsize = 6)
```
...
# You can also index into these results:
print(f"{pool_result[0]}, {pool_result[1]}, {pool_result[2]}") 
print(f"{welch_result[0]}, {welch_result[1]}, {welch_result[2]}") 
# prints t-statistic, p-value, degrees of freedom
```
...
#### Interpreting the Results: Main Effects {.example}
```{python}
...
#### Interpreting the Results: Main Effects, continued
...
#### Interpreting the Results: With Interaction {.example}
```{python}
...
#### Interpreting the Results: With Interaction, continued
