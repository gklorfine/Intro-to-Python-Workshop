...
execute:
    echo: True
    include: True
jupyter: ws # GK: I need to change this to 'workshop' once we finish all 3 days of the workshop
---
...
plt.plot(nums_x, nums_y, 'or', alpha=0.6)                      # 'or' = red circles
plt.show()
```
...
plt.plot(nums_x, nums_y, 'or')
#Adds reference line (x=y) as black solid line
...
plt.plot(nums_x, nums_y, 'or', label = "Observed")
